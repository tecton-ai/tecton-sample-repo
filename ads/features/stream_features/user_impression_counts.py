...
@stream_feature_view(
    ...
    features=[
        ...
        Aggregate(input_column=Field("impression", Int32), function="count", time_window=timedelta(days=1)),
        Aggregate(input_column=Field("impression", Int32), function="count", time_window=timedelta(days=3))
    ],
