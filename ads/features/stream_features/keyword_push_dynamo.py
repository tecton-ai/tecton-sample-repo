...
from ads.data_sources.ad_impressions import keyword_push_source_dynamo
...
@stream_feature_view(
    name="keyword_push_dynamo_wafv",
    source=FilteredSource(keyword_push_source_dynamo),
...
def keyword_push_dynamo_wafv(click_push_source):
