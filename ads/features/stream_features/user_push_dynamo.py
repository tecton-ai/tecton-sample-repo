...
from ads.data_sources.ad_impressions import user_push_source_dynamo
...
user_push_dynamo_no_transform = StreamFeatureView(
    name="user_push_dynamo_no_transform",
    source=user_push_source_dynamo,
    entities=[user],
    online=True,
    offline=True,
