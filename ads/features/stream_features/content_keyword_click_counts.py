...
from tecton.v09_compat import FilteredSource, Aggregation, DatabricksClusterConfig, StreamProcessingMode
...
@stream_feature_view(
    ...
    features=[Aggregate(input_column=Field("clicked", Int32), function="count", time_window=timedelta(minutes=1)), Aggregate(input_column=Field("clicked", Int32), function="count", time_window=timedelta(minutes=5))]
)
