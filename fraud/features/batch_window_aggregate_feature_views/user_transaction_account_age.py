...
@batch_window_aggregate_feature_view(
    ...
    aggregations=[FeatureAggregation(column='account_age_days', function='mean', time_windows=['24h','168h','336h']),
                  FeatureAggregation(column='account_age_days', function='max', time_windows=['24h','168h','336h'])],
    online=False,
    offline=False,
