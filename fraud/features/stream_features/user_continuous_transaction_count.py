...
from tecton.v09_compat import FilteredSource, Aggregation, StreamProcessingMode
...
@stream_feature_view(
    ...
    features=[Aggregate(input_column=Field("transaction", Int32), function="count", time_window=timedelta(minutes=1)), Aggregate(input_column=Field("transaction", Int32), function="count", time_window=timedelta(minutes=30)), Aggregate(input_column=Field("transaction", Int32), function="count", time_window=timedelta(hours=1))],
    online=False,
    offline=True,
